...
| **CTR-008**  | ~~Organization → Integrations → AI analysis~~ → **Organization → AI analysis**       | Admin      | BYO API key; Answer style default; seven core prompts and five conversion prompts, semantics only; prompted catalog Fields and their answer style stay under Contracts → Fields (CTR-008 addendum 2026-09-20). _Placement superseded by **SET-008**: the pane is an Organization section of its own, not an Integrations tab._ |
