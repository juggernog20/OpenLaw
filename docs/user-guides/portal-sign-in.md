...
In **Documents**, the **Primary Document** label marks the Contract's primary file. Select a Document name to read its current Version, or use its download control. Use **Your Contracts** to return to the list and **Show more** for more records.

## Open your Matters

Select **Matters** in the Portal navigation bar and open a row. Check its M- reference, title, Matter Type, Status, Matter Manager and Business Owner. The list uses the same current-team rule as Contracts.
