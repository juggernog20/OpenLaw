...
| INT-006 | Triage: one Inbox, pickup assignment, four actions, lossless re-convert      | Accepted; revised by INT-007; the Inbox read's address, toggle, ordering, and converted-link rule added by the M21/2 addendum                                                                                                                                                                                                                                                                            |
| INT-007 | Disposition-at-pickup: triage decides the outcome; no parked in-review state | Accepted; the triaged toggle's shape recorded by the INT-006 M21/2 addendum                                                                                                                                                                                                                                                                                                                              |
