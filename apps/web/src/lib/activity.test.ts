...
const SAMPLE_PAYLOADS: { [A in ActivityAction]: ActivityPayloadMap[A] } = {
  ...
  "region.created": TAXONOMY_NAMED,
  "region.renamed": TAXONOMY_RENAME,
  "region.updated": TAXONOMY_UPDATE,
  "region.reordered": { order: ["sales", "finance"] },
  "region.archived": TAXONOMY_ARCHIVE,
  "region.restored": TAXONOMY_NAMED,
  "region.deleted": TAXONOMY_NAMED,
  ...
  "entity_share_class.created": { legalName: "Helix Labs GmbH", className: "Ordinary" },
  "entity_share_class.updated": {
    legalName: "Helix Labs GmbH",
    className: "Ordinary",
    changed: { authorized: { from: 1000, to: 2000 } },
  },
  "entity_share_class.archived": { legalName: "Helix Labs GmbH", className: "Ordinary" },
  "entity_share_entry.created": {
    ...
    className: "Ordinary",
    quantity: 500,
    fromName: "Helix Holdings Inc.",
    toName: "Nadia Counsel",
  ...
  "entity_share_entry.updated": {
    ...
    toName: "Nadia Counsel",
    effectiveOn: "2026-09-18",
    changed: { quantity: { from: 500, to: 600 } },
  },
  ...
  "request.department_changed": { number: 42, from: "Finance", to: "Sales" },
