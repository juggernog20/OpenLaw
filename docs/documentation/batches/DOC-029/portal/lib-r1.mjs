// Shared helpers for the DOC-029 portal independent walkthrough (round 1).
...
if (!PASSWORD) throw new Error("LAB_SEED_PASSWORD is required (the seed password from VALIDATION.md)");
export const PEOPLE = {
