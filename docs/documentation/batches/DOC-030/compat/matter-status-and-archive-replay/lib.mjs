// DOC-030 compatibility replay (set compat): copy of DOC-029/compat-r2/matters-r2/lib-r1.mjs. Changes: root resolves to this worktree from the folder depth; work2 ports 43300/48425;
// the Portal sign-in waits out the sign-in link budget.
// Shared helpers for the DOC-029 matters independent walkthrough (round 1).
