// DOC-029 analysis-standin, round 1: shared helpers for the independent walkthrough.
...
export const PROJECT = process.env.LAB_PROJECT ?? "openlaw-docs-41255c61-analysis-r1";
