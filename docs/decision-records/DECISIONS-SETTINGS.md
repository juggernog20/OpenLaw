...
| **CTR-008**  | Settings → Organization → Integrations → AI analysis                                 | Admin      | BYO API key; seven editable core prompts; prompted catalog Fields stay under Contracts → Fields                                                                                                                          |
