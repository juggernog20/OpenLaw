...
| `email_logo_png`               | text        | Nullable 48×48 PNG copy as base64 without a data URI prefix, for inline email attachments. Written and cleared with `logo`; existing logos are backfilled once at API startup. **TECH-011**, **DES-093**, migration `0163`.                                                        |
