// Local OpenID Connect fixture for the DOC-030 admin-org V-C37 walkthrough.
// oauth2-mock-server 9.2.0 (the API test dependency, read from the worktree
// mounted at /repo) serves discovery, authorize, token, JWKS and userinfo on
// port 8080 under the issuer http://oidc:8080. Port 8081 is a fixture control:
// POST /identity {sub,email,name} selects the fictional identity that the next
