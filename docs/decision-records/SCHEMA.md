...
| `answer_style`                 | text (enum) | not null, default `sentence`; `few_words` \| `sentence` \| `full_clause`, checked by the database; organization Answer style for Contract text Fields, migration `0154` (**CTR-008**) |
