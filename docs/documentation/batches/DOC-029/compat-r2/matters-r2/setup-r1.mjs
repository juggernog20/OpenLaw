// Fixture setup for the DOC-029r2 matters independent walkthrough (round 1).
...
await field("fieldRequired", "DOC-029r2 matters required note", "text", "legal");
await field("fieldOptional", "DOC-029r2 matters optional note", "text", "business");
await field("fieldEntity", "DOC-029r2 matters Entity", "entity", "business");
await field("fieldPerson", "DOC-029r2 matters person", "user", "business");
await field("fieldNumber", "DOC-029r2 matters retype number", "number", "business");
...
await type("typeMain", "DOC-029r2 matters type", [
  ["fieldRequired", true],
  ["fieldOptional", false],
  ["fieldEntity", false],
  ["fieldPerson", false],
]);
await type("typeRetype", "DOC-029r2 matters retype", [
  ["fieldRequired", true],
  ["fieldNumber", true],
]);
...
await template("templateAlpha", {
  name: "DOC-029r2 matters alpha playbook",
  description: "Fictional review plan for the walkthrough.",
  priority: "high",
  risk: "critical",
  titlePrefix: "DOC-029r2 alpha review -",
  tasks: [
    { title: "DOC-029r2 alpha evidence review", dueOffsetDays: 3, assigneeRole: "matter_manager" },
    { title: "DOC-029r2 alpha discussion", dueOffsetDays: null, assigneeRole: "none" },
  ],
  keyDates: [
    { label: "DOC-029r2 alpha kickoff", offsetDays: 0, note: null },
    { label: "DOC-029r2 alpha filing", offsetDays: 7, note: "Fictional filing window." },
  ],
  defaults: { [req()]: "Alpha required default", [opt()]: "Alpha optional default" },
});
await template("templateBeta", {
  name: "DOC-029r2 matters beta playbook",
  description: "Second fictional plan.",
  priority: "low",
  risk: "low",
  titlePrefix: "DOC-029r2 beta review -",
  tasks: [{ title: "DOC-029r2 beta check", dueOffsetDays: 5, assigneeRole: "none" }],
  keyDates: [{ label: "DOC-029r2 beta date", offsetDays: 10, note: null }],
  defaults: { [opt()]: "Beta optional default" },
});
await template("templateGamma", {
  name: "DOC-029r2 matters gamma playbook",
  description: "Archived during the walkthrough to test a stale selection.",
  priority: "medium",
  risk: "medium",
  titlePrefix: "DOC-029r2 gamma review -",
  tasks: [],
  keyDates: [],
  defaults: {},
});
