// DOC-029 round 2 compatibility replay for the access group (find-your-work, search-and-views, personal-settings).
// Replays the round 1 walkthrough modules unchanged except for lab names and "DOC-029r2 access" record names.
// Usage: node run-r2.mjs [home] [search] [settings]. Writes replay-r2.json in this folder (or replay-r2.<modules>.json).
...
const log = makeLog({
  ...
  group: "access",
  round: 2,
  reviewer: "DOC-029r2 compatibility reviewer (access)",
  reviewerKind: "agent",
