...
Planning only. These are proposed issue bodies, not live GitHub issues. See the
[plan](PLAN.md) for gates and the [matrix](COVERAGE.md) for coverage IDs and sources.
No authoring or Help implementation has started as part of this planning task.
...
Dependencies: none. Coverage: C01–C51, audit only.
...
Dependencies: DOC-001. Coverage: C01–C51, mapping only.
...
Parent: DOC-E5. Gate: G4. Dependencies: DOC-008. Coverage: C31–C32.
...
- [ ] Verify archive/restore and in-use restrictions; link configurable types/Officer
      roles and shared Documents guidance without implying unimplemented calendars.
...
- [ ] Walk the completed first-run wizard and skipped-step checklist on a fresh
      instance, including optional connectors and review of seeded configuration.
...
Coverage: C01–C51, independent verification.
...
and the pilot. These five tickets prepare the project without beginning guide writing.
The rest of this backlog remains proposed until the project reaches those gates.
