...
| CMT-010 | Audience resolution takes one arm per entity type; downstream takes the answer | Accepted; the `request` arm added by the M20/7 addendum; its mention candidates, its silent mentions, and its author corrections recorded by the M20/10 addendum; the erasure invariant recorded by the #390 addendum |
