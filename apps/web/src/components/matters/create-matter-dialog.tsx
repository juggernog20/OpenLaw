...
export function CreateMatterDialog({
  ...
  async function submit() {
    ...
    await attachments.upload({ entityType: "matter", number: result.data.matter.number }, () => {
        ...
        {attachments.created ? (
          ...
          >
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="matter-new-title" required>
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="matter-new-type" required>
              ...
              <select
                ...
                onChange={(event) => {
                  ...
                  if (templateId) seedTemplate(nextType, "");
                  else setTemplateId("");
                  setError(null);
                }}
              >
