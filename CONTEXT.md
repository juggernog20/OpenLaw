...
**Business User**:
An employee who uses the Portal to submit Requests and work on non-archived Contracts and Matters they are on the team for. They edit business Fields, add Documents and Versions, including primary Contract Document Versions, and post Full Thread replies. Team membership is their only record grant [DD-023, DD-024].
...
Built-in, nullable Contract attributes describing its business classification. Both live in Overview for every Contract Type, outside its configurable Fields. Business Users on the team can edit them. Neither grants access [CTR-025].
