// Shared helpers for the DOC-029 publication review (V-HELP and V-OFFLINE).
...
export { chromium };
export const BASE = process.env.LAB_APP_URL ?? "http://127.0.0.1:23340";
export const MAIL = process.env.LAB_MAIL_URL ?? "http://127.0.0.1:23440";
export const REVIEWER = "DOC-029 independent publication reviewer agent";
...
/** The same compiler the image ran; used only to state the expected reader sets. */
export const bundle = compileWorkspace().bundle;
