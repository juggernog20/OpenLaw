...
- **Status** — Accepted (link-time-nudge behavior applies to matters; contract behavior governed by CTR-022)
- **Date** — 2026-08-04
...
- **Consequences** — No schema change. Link-creation flows (contract↔matter, contract↔contract) need the nudge affordance. Restricted-placeholder rendering (already committed in MTR-015) extends to contract surfaces. Note: CTR-022 governs contract-specific confidentiality behavior including actor set and access rules.
