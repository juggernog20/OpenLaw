...
Source: **ADO-001–010**, grilled 2026-09-13. M35/5 (#848, migration 0120) builds the record identity, template ownership, detection metadata, and immutable form snapshots below. M35/6, migration 0121, adds publication, maps, rules, audience, and the target Type. M35/8, migration 0123, adds delivery settings and outcomes. M35/9, migration 0124, adds title and Entity settings and Contract provenance. Audience allowlists remain the intended shape for the following M35 tasks.
