...
4. Leave the recipient checkboxes clear to use the usual audience: the Legal Owner, Business Owner, and everyone on the Contract team. The checkboxes include active Business Users on that team. Select people to send this Key date's reminders only to those people. Their current access and notification preferences still apply; selecting someone grants no access.
