...
| **CTR-008**  | ~~Organization → Integrations → AI analysis~~ → **Organization → AI analysis**       | Admin      | BYO API key; seven editable core prompts; prompted catalog Fields stay under Contracts → Fields. _Placement superseded by **SET-008**: the pane is an Organization section of its own, not an Integrations tab._ |
