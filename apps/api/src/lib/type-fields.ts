...
import type { contractTypeFields, entityTypeFields, matterTypeFields } from "@openlaw/db";

/** Shared by HTTP Field attachment routes and background extraction. */
export type TypeFieldsTable =
  typeof contractTypeFields | typeof entityTypeFields | typeof matterTypeFields;
