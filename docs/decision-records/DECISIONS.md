...
- Enabling On intake form also enables Visible on Portal in the builder. The Portal switch then locks with a reason. The API still refuses an intake Field whose Portal switch is off. This follows #1012 and replaces DES-090's proposed refusal before enabling intake.
