...
Status: proposed execution plan; planning only. Prepared 2026-09-06.
...
This planning package contains the [coverage matrix](COVERAGE.md) and
[proposed GitHub backlog](BACKLOG.md). It does not contain user guides. Backlog IDs
are local planning IDs; they are not published GitHub issues or commitments to dates.
...
Resolve these differences in DOC-001:
