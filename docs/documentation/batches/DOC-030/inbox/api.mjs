// Shared helpers for the DOC-030 inbox independent walkthrough.
...
export const PEOPLE = {
  ...
  // Requesters of the recorded run: seeded Business Users no other DOC-030 group names, so the
  // three-per-15-minutes sign-in link budget and the 20-per-hour submission limit stay free.
  requester_a: { email: "oliver.grant@helix.example", name: "Oliver Grant" },
  requester_b: { email: "rosa.iglesias@helix.example", name: "Rosa Iglesias" },
  // Requesters for development runs only.
  dev_requester: { email: "diego.salas@helix.example", name: "Diego Salas" },
  dev_requester_2: { email: "karim.aziz@helix.example", name: "Karim Aziz" },
};
