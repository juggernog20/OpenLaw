// DOC-029 round 2 compatibility replay copy of conversations/lib-r1.mjs; only the Playwright import path changed.
// Shared helpers for the DOC-029 conversations independent walkthrough; copied from the portal group helper (round 1).
...
const PASSWORD = process.env.LAB_SEED_PASSWORD ?? "correct-horse-battery";
export const PEOPLE = {
  ...
  ravi: { email: "ravi.menon@helix.example", role: "contributor" },
