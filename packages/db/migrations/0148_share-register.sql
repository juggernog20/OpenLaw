CREATE TABLE "entity_share_certificates" (
	...
	CONSTRAINT "entity_share_certificates_quantity_positive" CHECK ("entity_share_certificates"."quantity" > 0),
...
CREATE TABLE "entity_share_classes" (
	...
	CONSTRAINT "entity_share_classes_authorized_range" CHECK ("entity_share_classes"."authorized" is null or "entity_share_classes"."authorized" >= 0),
	CONSTRAINT "entity_share_classes_par_value_range" CHECK ("entity_share_classes"."par_value" is null or "entity_share_classes"."par_value" >= 0),
...
CREATE TABLE "entity_share_entries" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "entity_share_entries_quantity_positive" CHECK ("entity_share_entries"."quantity" > 0),
	...
	CONSTRAINT "entity_share_entries_price_range" CHECK ("entity_share_entries"."price_per_share" is null or "entity_share_entries"."price_per_share" >= 0),
...
ALTER TABLE "entity_share_certificates" ADD CONSTRAINT "entity_share_certificates_holder_id_entity_shareholders_id_fk" FOREIGN KEY ("holder_id") REFERENCES "public"."entity_shareholders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_share_certificates" ADD CONSTRAINT "entity_share_certificates_share_class_id_entity_share_classes_id_fk" FOREIGN KEY ("share_class_id") REFERENCES "public"."entity_share_classes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_share_certificates" ADD CONSTRAINT "entity_share_certificates_issued_by_entry_id_entity_share_entries_id_fk" FOREIGN KEY ("issued_by_entry_id") REFERENCES "public"."entity_share_entries"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_share_certificates" ADD CONSTRAINT "entity_share_certificates_cancelled_by_entry_id_entity_share_entries_id_fk" FOREIGN KEY ("cancelled_by_entry_id") REFERENCES "public"."entity_share_entries"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "entity_share_entries" ADD CONSTRAINT "entity_share_entries_share_class_id_entity_share_classes_id_fk" FOREIGN KEY ("share_class_id") REFERENCES "public"."entity_share_classes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_share_entries" ADD CONSTRAINT "entity_share_entries_to_share_class_id_entity_share_classes_id_fk" FOREIGN KEY ("to_share_class_id") REFERENCES "public"."entity_share_classes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_share_entries" ADD CONSTRAINT "entity_share_entries_from_holder_id_entity_shareholders_id_fk" FOREIGN KEY ("from_holder_id") REFERENCES "public"."entity_shareholders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "entity_share_entries" ADD CONSTRAINT "entity_share_entries_to_holder_id_entity_shareholders_id_fk" FOREIGN KEY ("to_holder_id") REFERENCES "public"."entity_shareholders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
