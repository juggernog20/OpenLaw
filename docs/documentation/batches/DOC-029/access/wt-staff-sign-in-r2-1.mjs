...
export async function run(log, fx) {
  ...
  log.notRun(
    ...
    "Not observable: the lab app container sets AUTH_RATE_LIMIT=off, which disables the sign-in rate limiter that produces the 15-minute message. No repeated-failure run was made in round 2.",
  );
