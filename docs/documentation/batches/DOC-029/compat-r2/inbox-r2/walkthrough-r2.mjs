  ...
  await step(
    ...
    async () => {
      ...
      for (const needle of [
        ...
        "Attachments",
        "Converts to",
        "Contract · DOC-029r2 inbox Supplier agreement",
        "Requester",
        "Jonas Weber",
        "Department",
        "Engineering",
  ...
  await step(
    ...
    async () => {
      ...
      for (const R of [Cc, Cm]) {
        ...
        writeFileSync(
          legalFile,
          makePdf(`DOC-029r2 inbox legal paper ${R.reference}`, ["Fictional internal note paper."]),
        );
        writeFileSync(
          sharedFile,
          makePdf(`DOC-029r2 inbox shared paper ${R.reference}`, [
    ...
    async () => {
      ...
      for (const key of ["business_user", "second_business_user"]) {
        ...
        const conv = await bp.request.post(`${BASE}/api/v1/requests/${n}/convert`, {
          data: { title: "DOC-029r2 inbox refused" },
          headers: { origin: BASE },
        });
