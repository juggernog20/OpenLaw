...
`activity_log.entity_type` gains `auto_doc`. Verbs: `auto_doc.created`, `.updated`, `.published`, `.unpublished`, `.archived`, `.restored`, `.generated`, `.generation_retried`, `.filed`, `.acknowledged`, `.form_saved`, `.template_uploaded`.
