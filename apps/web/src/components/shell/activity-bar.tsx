 ...
 * Those are the newest mock suite and the one that draws the decided
 * applet set: a 48px strip on the record's trailing edge with 12px
 * vertical padding, 32px icon slots on an 8px gap, and a 24px divider
 * ahead of the below-divider group. Everything sits on body surface
 * tokens. The frames' fills are exactly raised / border-default /
 * border-muted / text-muted in Light values, not the DES-019 chrome
 * group, which exists for the top slab that restructures per theme.
 *
