// DOC-029 round 2 compatibility replay copy of conversations/walkthrough-r1.mjs, by the DOC-029r2 compatibility reviewer (conversations).
...
async function shots() {
  ...
  await step(NT, "business_user", "Screenshot: Portal bell item for a team comment on the Contract converted from his Request", "Item reads replied on your request", async () => {
    await comment(n, "contract", fx.contractId, `DOC-029r2 conversations ${fx.stamp} screenshot team comment`, "full_thread");
