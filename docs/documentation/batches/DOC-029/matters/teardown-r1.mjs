// Teardown for the DOC-029 matters walkthrough (round 1): archives the DOC-029 Matter templates,
// Matter types and Fields that setup-r1.mjs added, so the shared lab's live settings return to
// their earlier state. Records created during the walkthrough stay, named "DOC-029 matters ...".
...
// The DOC-029 Matter types are in use only by DOC-029 walkthrough Matters; archiving them moves
