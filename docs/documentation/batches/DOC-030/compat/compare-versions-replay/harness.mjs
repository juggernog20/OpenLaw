// DOC-030 compatibility replay (set compat): copy of DOC-029/compat-r2/analysis-standin-r2/harness-r2.mjs. DOC-030 changes: default lab is the separate compatcmp lab (app 43345, Mailpit 48455, project openlaw-docs-80ceef9e-compatcmp).
...
export const BASE = process.env.LAB_APP_URL ?? "http://127.0.0.1:43345";
export const MAIL = process.env.LAB_MAIL_URL ?? "http://127.0.0.1:48455";
export const PROJECT = process.env.LAB_PROJECT ?? "openlaw-docs-80ceef9e-compatcmp";
