...
| `onboarding_reviewed_types_at` | timestamptz | Nullable; the first Administrator acknowledgement of the seeded lists in Review (**SET-004**, #700). One-way and idempotent; skipping Review leaves it NULL.                                                         |
