...
A visible preference does not grant the underlying role or record access. A Business User does not receive Inbox arrivals, date reminders, or the daily briefing. Activity notifications go to the record's audience, not every Legal Team Member who could open it. Comment tiers and separately Confidential Documents can narrow that audience further.
