// Shared helpers for the DOC-030 documents-2 independent walkthrough.
// Written by the DOC-030 independent walkthrough agent (documents-2), from the DOC-029 lib-r1.mjs pattern.
