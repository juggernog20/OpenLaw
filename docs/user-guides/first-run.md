...
2. In **Your organization**, enter **Organization name**. You can select **Upload** to add a PNG, JPEG, WebP, or SVG logo under 256 KB, and choose a **Default timezone**. **Default locale** offers only English (United States) in this version. Select **Continue** to save.
...
10. In **Review**, check the row counts of the seeded lists and the reminder offsets. Select **Finish** to record the review and enter the app.
...
Reloading an unfinished wizard returns to its Welcome step. Select **Get started** again. Saved settings remain, but unsaved form entries and the current step do not. Check each saved choice before continuing. Until onboarding is complete, Home opens the wizard again. While email is not configured, every app page opens the wizard.
