...
| I.B3 | Term 2 bar                         | Both     | done   | keep — one bar per confirmed renewal event (activity_log per CTR-006)                                                                              | Decision stands; not built in M16/2. That slice draws the periods the record's dates imply — a bar per **confirmed** roll waits for the slice that writes the log entry. **DES-041** clause 3. |
| I.B4 | Term 3 bar                         | Both     | done   | keep — bar count = confirmed renewals + 1; renewals routed to amendment/child/new contracts (CTR-007) render on those records, not extra bars here | Decision stands; not built in M16/2, with I.B3.                                                                                                                                                |
| I.B5 | Last renewal marker                | V12      | done   | keep — same datum as G.R5                                                                                                                          | Decision stands; not built in M16/2, with G.R5 and I.B3.                                                                                                                                       |
