...
type DocumentPayloads = {
  ...
  "document.created": {
    ...
    /** The initial file was generated by an Auto-Doc. */
    generatedFromGenerationId?: string;
...
type AiConnectorPayloads = {
  "ai_saved_key.forgotten": { preset: string; protocol: string; baseUrl: string };
  "ai_saved_key.stored": {
    preset: string;
    protocol: string;
    baseUrl: string;
