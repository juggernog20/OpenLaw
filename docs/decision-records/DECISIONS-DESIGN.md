...
- A Branch footer shows **Add row into branch**, **Create Field**, and **Add branch**. The latter adds a nested Branch there, as does **Add branch inside** in the overflow menu. Removal reads **Remove branch · Keep children here**. The shared heading strip reflows at the specified 848px content width, with 24px indentation per Branch.
