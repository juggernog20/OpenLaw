...
| **CTR-008**  | ~~Organization → Integrations → AI analysis~~ → **Organization → AI analysis**       | Admin      | Four collapsed cards: Provider, Answer style, Conversion draft prompts and Contract analysis prompts, with the open Request conversion switches card after Provider once a connector is saved; seven core prompts and five conversion prompts, semantics only, with the format sentence enforced in code and not shown (2026-09-21); prompted catalog Fields and their answer style stay under Contracts → Fields (CTR-008 addendum 2026-09-20). _Placement superseded by **SET-008**: the pane is an Organization section of its own, not an Integrations tab._ |
