...
2. In **Your organization**, enter **Organization name**. You can select **Upload** to add a PNG, JPEG, WebP, or SVG logo of 5 MB or smaller and no more than 16 million pixels, and choose a **Default timezone**. **Default locale** offers only English (United States) in this version. Select **Continue** to save. The sign-in pages then show the saved organization name and logo.
