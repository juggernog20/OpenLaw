...
| `entity_type`          | text (enum) | `matter` \| `contract` \| `document` \| `request`. Polymorphic with `entity_id`, so no FK — the documented exception, as `comments` has it. Only `contract` is written in M18                                                                                                                                                                                                   |
