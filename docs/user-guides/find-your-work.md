...
1. Select **Home** in the app navigation.
2. Find the relevant section and select a Task or record title.
3. Check the record number and title before acting.
4. Use the record's section links to open the information you need, such as **Fields** or **Documents** on a Contract.
5. Select **Home** to return to your summary.
