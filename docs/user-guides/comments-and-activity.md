# Choose who can read a comment

Keep a conversation with its Contract, Matter, or Request, and choose the audience before posting.

## Before you start

- Administrators and Legal Team Members can use conversations on work they can reach. A Business User must be on the team of the specific Contract or Matter, and the record must not be archived.
- Business Users reply on their own Request in the Portal until Legal converts it. Conversion adds the Requester to the team of the new Contract or Matter. After that, current team membership controls access.
...
## Choose an audience on a record

1. Open the Contract or Matter and select **Comments**.
2. Above **New comment**, choose **Legal Only**, or choose **Contract Team** on a Contract and **Matter Team** on a Matter. New comments start on the team audience. Read the audience description below the composer.
3. Write in **New comment**.
4. Select **Comment** and check that the post appears under your name with the intended audience badge.

| Audience                             | Who can read it                                                                                                                    |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Legal Only**                       | Administrators and Legal Team Members who can reach the record. Business Users cannot choose or read this audience.                |
| **Contract Team** or **Matter Team** | Legal users who can reach the record and the Business Users currently on its team. This is the Full Thread tier.                   |
| **Internal team**                    | Older Working Team comments only. Legal users who can reach the record. Business Users cannot read them. You cannot choose it now. |
...
2. Choose the person on the **People** tab. Check the **Mentioned** list. Typing a name as ordinary text alone does not select a recipient.
3. Finish the comment and select **Comment**.
4. If **Widen the audience?** appears, read the proposed audience. Select **Widen and post** only if the whole message and its attachments belong in that audience. Select **Cancel** to keep editing without posting.
...
1. Write the comment, then select **Attach files** and choose up to five files.
2. Check the selected filenames. Use **Remove** beside a file to take it out before posting.
3. Check the audience again, then post the comment.
4. Confirm that the post contains its attachments. Select an attachment's filename to preview it. Use its **Download** control to retrieve the file.
...
On the Contract, Matter, or Legal Request conversation, open **Comment actions** on your own live comment.
...
After conversion, the Request address opens its Contract or Matter, and you are on its team. Continue in that record's Comments applet. Removing your team membership removes access. If Legal archives the record, the Request address shows your original request with no conversation.
