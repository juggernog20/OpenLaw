...
- **Status** — Accepted; **extended by CMT-010**, which says how "one machinery" is built — one audience arm per entity type; **extended by CMT-011**, which gives the thread the paper it could not carry; the re-parent built and recorded by the M21/11 addendum below
- **Date** — 2026-08-05
