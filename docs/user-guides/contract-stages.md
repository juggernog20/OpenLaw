# Change a Contract Status

Record where a Contract stands and check the Stage that its Status represents.
...
Ended Contracts stay editable. Archiving is a separate action that makes the record read-only. [Relate, end, and archive Contracts](contract-relations-and-ending.md) explains finding and reopening them.
